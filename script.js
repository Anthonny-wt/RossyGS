const math = {
  ...
  document.getElementById('paraEl').addEventListener('click', function() {
    window.location.href = '/Barber/PrincipalBarber/index.html'; // Reemplaza con la ruta relativa a la que deseas redirigir
  });

  document.getElementById('paraElla').addEventListener('click', function() {
    window.location.href = '/peluqueriaMujeres/index.html'; // Reemplaza con la ruta relativa a la que deseas redirigir
  });
